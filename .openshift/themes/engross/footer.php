...
<span class="alignright "> <?php if(is_home() AND !is_paged()) { ?><a href="http://wpdean.com/engross-wordpress-theme/" >Engross</a> Theme. <?php }  else { ?><a href="https://wordpress.org/themes/engross/" >Engross</a> Theme.<?php  } ?> Powered by <a href="http://wordpress.org/">WordPress</a>.</span></p>
